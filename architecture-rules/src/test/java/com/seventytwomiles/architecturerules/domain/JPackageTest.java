...
public class JPackageTest extends TestCase {
    ...
    public void testMatch_perfect_pass() throws Exception {
    ...
    public void testMatch_perfect_fail() throws Exception {
     ...
     */
    public void testMatchPackage_wildcards_pass() throws Exception {
    ...
    public void testMatchPackage_wildcards_fail() throws Exception {
     ...
     */
    public void testMatchSubPackage_wildcards_pass() throws Exception {
    ...
    public void testMatchSubPackage_wildcards_fail() throws Exception {
    ...
    public void testMatchInnerPackage_wildcards_pass() throws Exception {

        final JPackage wild;
        wild = new JPackage("com.seventytwomiles.*.dao.hibernate");

        assertTrue(wild.matches(
                new JPackage("com.seventytwomiles.project1.dao.hibernate")));

        assertTrue(wild.matches(
                new JPackage(
                        "com.seventytwomiles.project2.dao.hibernate")));

        assertTrue(wild.matches(
                new JPackage("com.seventytwomiles.project3.dao.hibernate")));
    }


    public void testMatchInnerPackage_wildcards_fail() throws Exception {

        final JPackage wild;
        wild = new JPackage("com.seventytwomiles.*.dao.hibernate");

        assertFalse(wild.matches(
                new JPackage("com.seventytwomiles.project1.services")));
        ...
        assertFalse(wild.matches(
                new JPackage("com.seventytwomiles.*.dao.hibernate")));
    }
    ...
    public void testMatchInnerAndTerminatingPackage_wildcards_pass()
        ...
        assertTrue(wild.matches(
                new JPackage("com.seventytwomiles.project2.dao.hibernate")));

        assertTrue(wild.matches(
                new JPackage("com.seventytwomiles.project1.dao.ldap")));

        assertTrue(wild.matches(
                new JPackage("com.seventytwomiles.project3.dao.jdbc")));
    }
    ...
    public void testMatchInnerAndTerminatingPackage_pass()
        ...
        assertTrue(new JPackage("com.seventytwomiles..*.filter.*").matches(
                new JPackage(
                        "com.seventytwomiles.project1.web.filter.security")));

        assertTrue(new JPackage("com.seventytwomiles..*.filter").matches(
                new JPackage(
                        "com.seventytwomiles.project1.web.filter")));

        assertTrue(new JPackage("com.seventytwomiles..*.filter..*").matches(
                new JPackage(
                        "com.seventytwomiles.project1.web.filter.security.ws")));

        assertTrue(new JPackage("com.seventytwomiles.*.web.*").matches(
                new JPackage(
                        "com.seventytwomiles.project1.web.filter")));
        ...
        assertTrue(new JPackage("com..*").matches(
                new JPackage(
    ...
    public void testMatchInnerAndTerminatingPackage_fail()
        ...
        assertFalse(new JPackage("com.seventytwomiles..*.filter.*").matches(
                new JPackage(
                        "com.seventytwomiles.project1.web.controller.api")));
        ...
        assertFalse(new JPackage("com.seventytwomiles..*.filter..*").matches(
                new JPackage(
                        "com.seventytwomiles.filter.security.ws")));

        assertFalse(new JPackage("com.seventytwomiles.*.web.*").matches(
                new JPackage(
                        "com.seventytwomiles.project1.web")));

        assertFalse(new JPackage("com.seventytwomiles.*.web..*").matches(
                new JPackage(
                        "com.seventytwomiles.web.filter")));

        assertFalse(new JPackage("com.seventytwomiles.*.web..*").matches(
                new JPackage(
                        "com.seventytwomiles.project1.web")));

        assertFalse(new JPackage("com.*").matches(
                new JPackage(
                        "com.seventytwomiles.project1")));
    }
}
