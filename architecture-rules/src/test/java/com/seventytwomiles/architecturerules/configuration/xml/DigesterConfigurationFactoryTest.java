 ...
 * @author mikenereson
 */
public class DigesterConfigurationFactoryTest
    extends AbstractDigesterTest
{
                                         ...
                                         throws Exception
    {
        ...
        } catch ( final Exception e )
        {
            ...
            assertEquals( "could not load resource this_file_does_not_exist.xml " + "from classpath. File not found.",
                          e.getMessage(  ) );
        }
    }
                            ...
                            throws Exception
    {
        ...
        assertEquals( "util" + File.separator + "target" + File.separator + "classes",
                      source1.getPath(  ) );
        ...
        assertEquals( "parent-pom" + File.separator + "target" + File.separator + "classes",
                      source2.getPath(  ) );
        ...
        assertEquals( "web" + File.separator + "target" + File.separator + "classes",
                      source3.getPath(  ) );
        ...
        throws Exception
    {
        ...
        } catch ( final Exception e )
        {
            ...
            assertEquals( "'INVLALID' is not a valid value for the sources " +
                          ...
                          "<sources no-packages=\"exception\"> or " + "leave the property unset.",
                          e.getMessage(  ) );
        }
    }
}
