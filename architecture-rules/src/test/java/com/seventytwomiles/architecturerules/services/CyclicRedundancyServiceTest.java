 ...
 * @author mikenereson
 */
public class CyclicRedundancyServiceTest
    extends TestCase
{
                                          ...
                                          throws Exception
    {
        ...
        } catch ( final CyclicRedundancyException e )
        {
             ...
             */
            assertTrue( "expected violation at test.com.seventytwomiles.services",
            ...
            assertTrue( "expected violation at test.com.seventytwomiles.dao.hibernate",
