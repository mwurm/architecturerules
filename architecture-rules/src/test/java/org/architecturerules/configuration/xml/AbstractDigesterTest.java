...
public class AbstractDigesterTest extends TestCase {
    ...
    final String withProperties = "<architecture><configuration><properties><propertyA>valueA</propertyA><propertyB>valueB</propertyB></properties></configuration></architecture>";
