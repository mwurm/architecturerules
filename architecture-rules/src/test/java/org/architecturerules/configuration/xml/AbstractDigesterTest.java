...
public class AbstractDigesterTest extends TestCase {
    ...
    final String withProperties = "<architecture><configuration><properties><property key=\"report.output.directory\" value=\"target/architecture\"/><property key=\"report.output.format\" value=\"xml\"/></properties></configuration></architecture>";
