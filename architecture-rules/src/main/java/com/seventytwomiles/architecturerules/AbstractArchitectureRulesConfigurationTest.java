...
public abstract class AbstractArchitectureRulesConfigurationTest
    ...
    /**
     * Upon instantiation, instances a new Configuration by reading the XML
    ...
    /**
     * <p>Runs tests that are configured either programmatically, or by the XML
    ...
    protected final boolean doTests() {
        ...
        if (configuration.shouldDoCyclicDependencyTest()) {
            ...
            final UnmodifiableConfiguration unmodifiableConfiguration
                    = new UnmodifiableConfiguration(configuration);
